...
var editTask=function(){
    ...
    var containsClass=editInput.classList.contains("tasks__input_edit");
    ...
    if(containsClass){
        ...
        editInput.classList.remove("tasks__input_edit");
        label.classList.remove("tasks__label_edit");
        editBtn.innerText="Edit";
    }else{
        editInput.value=label.innerText;
        editInput.classList.add("tasks__input_edit");
        label.classList.add("tasks__label_edit");
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".tasks__select");
    var editButton=taskListItem.querySelector(".tasks__button_edit");
    var deleteButton=taskListItem.querySelector(".tasks__button_del");
